...
Description
---------------------------------------------------------------------
Contains the initialization functions necessary for managing
the Ospro application.
"""
...
presLst = []
configDict = {}
applicationLoc = os.path.abspath(r"T:\Documents\Projects\Ospro")

# Configure Environment
if testEnv:
    diagDictVar = 'diagnosticsLoc'
    dirSep = '\\'
else:
    diagDictVar = 'diagnosticsLoc'
    dirSep = '/'
